...
export default function Hero() {
  const words = [
    "Machine Learning Enthusiast & AI Explorer",
  "Python Programmer & Data Analysis Learner",
  "AI Coding & Automation Passionate",
  "Exploring Deep Learning & Neural Networks",
  ];

  const [code] = useState(`
const profile = {
    name: 'SATWIKA ELUGURI',
    title: 'AI | Data Science Enthusiast | Quick Learner',
    skills: [
        'Python', 'Java', 'C++', 'ReactJS',
        '.NET', 'SQL', 'DBMS', 
    ...
    problemSolver: true,
    projects: [
        'AI-based Lung Cancer Detection using CT Scans',
        'Ensemble Wind Energy Forecasting for Grid Management'
    ],
    certifications: [
        'HackerRank Python, Java, SQL',
        'Cisco Programming in Python, C++, CCNA',
        'EDX Data Science in Python',
        'NPTEL Joy of Computing, Cybersecurity'
    ],
    GPA: 8.9,
    hireable: function() {
        return (
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  AI enthusiast 🤖 | Machine Learning Explorer 📊 | Coding insights from data to intelligence 💡💻
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://www.linkedin.com/in/satwika-eluguri-972a2b301/"
                ...
                {/* Contact Button */}
                <a
                  href="/images/Satwika-Eluguri.pdf"
                  target="_blank" rel="noopener noreferrer"
